...
Il prenait un nombre brut, le nettoyait, le réorganisait, et le renvoyait dans le monde sous une forme plus harmonieuse.
...
Le Conseil utilisait une règle simple :
si une valeur était plus grande qu’une autre, elle gagnait un point.
Si elle était plus petite, elle en perdait un.
Si elles étaient égales, elles se saluaient simplement, sans victoire ni défaite.

Ainsi naissait la puissance relative :
...
Et dans chaque case, le résultat de leur rencontre.

Cette matrice n’était pas un simple tableau :
...
Les sept valeurs formaient un cercle.
Chacune affrontait les six autres.
Et de ces duels naissait une hiérarchie subtile,
non pas pour dominer, mais pour comprendre qui amplifiait qui,
...
La puissance relative n’était pas un classement.
C’était une cartographie du vivant,
une manière de dire :

« Voilà comment nous nous influençons mutuellement.
Voilà comment nous existons ensemble. »
